...
public class OperatorsDynamicConfig {
    ...
    public long getBelongsToOperator() {
        return belongsToOperator;
    }

    public void setBelongsToOperator(long belongsToOperator) {
        this.belongsToOperator = belongsToOperator;
    }
    @Column
    public long getStartingRound() {
        return startingRound;
    }

    public void setStartingRound(long startingRound) {
        this.startingRound = startingRound;
    }
    @Column
    public int getDelay() {
    ...
    @Column
    public boolean isOnlyWholeNumbers() {
        return onlyWholeNumbers;
    }

    public void setOnlyWholeNumbers(boolean onlyWholeNumbers) {
        this.onlyWholeNumbers = onlyWholeNumbers;
    }
